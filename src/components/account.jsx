...
function Account({
  ...
  // --- رندر کامپوننت ---
  return <div id="account-view" className="account-overlay">
            <div className="account-wrapper">

                {/* هدر صفحه */}
                <div className="crm-top-header">
                    <div className="account-custom-element">
                        <h2 id="accountPageTitle" className="crm-title">
                            {customerToEdit ? 'ویرایش حساب' : 'ثبت حساب جدید'}
                        </h2>
                        {customerToEdit && <span className="account-subtitle">
                            کد مشتری: {toPersianDigits(getCustomerCode(customerToEdit, existingCustomers))}
                            </span>}
                    </div>

                    <div className="crm-header-buttons">
                        <button id="closeAccountBtn" className="crm-back-btn" onClick={handleClose}>
                            {/* اصلاح صفات SVG به صورت کمل‌کیس */}
                ...
                <div id="account-content" className="account-content">
                    <form className="account-form-card" onSubmit={e => {
          e.preventDefault();
          handleSave();
        }}>
                        ...
                        <div className="account-input-group">
                            ...
                            <input type="text" id="custNameInput" className="account-input" placeholder="مثال: آقای محمدی" value={customerName} onChange={e => setCustomerName(e.target.value)} />
                        </div>
                        ...
                        <div className="account-input-group profile-upload-group">
                            ...
                            <div className="profile-upload-wrapper">
                                <label htmlFor="custProfilePicInput" className="custom-file-upload">
                                    {/* مدیریت نمایش متن یا عکس با استفاده از شرط ری‌اکت */}
