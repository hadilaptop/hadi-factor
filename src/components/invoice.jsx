...
function Invoice({
  ...
  return (
    <div id="invoice-view" className="invoice-view" data-theme={theme}>
      {/* Header */}
      <div className="invoice-top-header">
        ...
        <div className="invoice-header-buttons">
          {step === "form" && (
            <>
              <button
                className="invoice-settings-btn"
                onClick={() => {
      ...
      {step === "form" && (
        <>
          ...
          <div
            className="invoice-bottom-bar"
            style={{ opacity: 1, animation: "none" }}
          >
            <div
              className="invoice-bottom-actions-card"
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: "0 4px 10px rgba(15, 76, 117, 0.4)",
                  padding: 0,
                }}
              ...
              <button
                type="button"
                className="action-btn save-ledger-btn"
                style={{
