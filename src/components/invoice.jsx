...
function Invoice({
  ...
  const handleSaveToDatabase = async () => {
    ...
    if (!targetCustomerId && buyerName.trim()) {
      ...
      if (window.confirm(confirmMsg)) {
        ...
        if (existingCust) {
          alert("مشتری با این نام از قبل وجود دارد. لطفاً از لیست انتخاب کنید یا نام دیگری وارد نمایید.");
          return;
        }
    ...
    if (!targetCustomerId) {
      alert("لطفاً یک مشتری را انتخاب کنید یا نام مشتری جدید را وارد نمایید.");
      return;
    }
  ...
  const generateInvoiceCanvas = async () => {
    ...
    // اطمینان از ریست بودن مقیاس و مختصات قبل از ساخت تصویر
    try {
        ...
        <div className="invoice-form-container">
          ...
          <div className="invoice-bottom-bar" style={{ opacity: 1, animation: 'none' }}>
            <div className="invoice-bottom-actions-card" style={{ position: 'relative' }}>
              ...
              <button type="button" className="action-btn" style={{ background: 'linear-gradient(180deg, #3282b8, #0f4c75)', width: 44, height: 44, borderRadius: '50%', color: 'white', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 10px rgba(15, 76, 117, 0.4)', padding: 0 }} onClick={() => setStep("preview")} title="پیش نمایش">
              ...
              <button type="button" className="action-btn save-ledger-btn" style={{ background: 'linear-gradient(180deg, #10b981, #059669)', width: 44, height: 44, borderRadius: '50%', color: 'white', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 10px rgba(16, 185, 129, 0.4)', padding: 0 }} onClick={handleSaveToDatabase} disabled={isSaving} title="ذخیره در حساب مشتری">
                {isSaving ? (
...
{exportModal.show && (
              ...
              <button type="button" className="action-btn save-ledger-btn" style={{ background: 'linear-gradient(180deg, #10b981, #059669)', width: 48, height: 48, borderRadius: '50%', color: 'white', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 10px rgba(16, 185, 129, 0.4)', padding: 0 }} onClick={handleSaveToDatabase} disabled={isSaving} title="ثبت در حساب مشتری">
                {isSaving ? (
              ...
              <button type="button" className="action-btn share-btn" style={{ background: 'linear-gradient(180deg, #3282b8, #0f4c75)', width: 48, height: 48, borderRadius: '50%', color: 'white', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 10px rgba(15, 76, 117, 0.4)', padding: 0 }} onClick={shareAsImage} disabled={isSaving} title="اشتراک‌گذاری">
